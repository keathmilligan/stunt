# Capability: Tunnel Configuration

## Purpose
Defines the data model for SSH server entries and tunnel forward definitions, TOML-based serialization, platform-appropriate persistent storage, and atomic file writes.
