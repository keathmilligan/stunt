# Capability: TUI List View

## Purpose
Defines the terminal user interface layout, server entry rendering, scrolling, navigation, key bindings, and color-coded connection state display.
